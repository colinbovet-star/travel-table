  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div
        ...
        className={`
          relative cursor-pointer border-2 border-dashed border-[var(--pink-mid)]
          bg-[var(--cream)] hover:bg-[var(--cream-dark)] transition-colors
          flex items-center justify-center overflow-hidden
          ${circular ? 'w-28 h-28 rounded-full' : 'w-full h-36 rounded-2xl'}
        `}
      >
        {value ? (
          <img
